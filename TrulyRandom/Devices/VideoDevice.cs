...
public class VideoDevice : DirectShowDevice
{
    ...
    /// </summary>
    public static IEnumerable<DeviceDescriptor> AvailableDevices => GetAvailableDevices(Clsid.VideoInputDevice);

    private static readonly object autoSearchLock = new();
    ...
    private static void SetCapabilities(IAMStreamConfig_Video streamConfig, VideoCapabilities capabilities)
    {
        ...
        {
            if (capabilities == new VideoCapabilities(streamConfig, i))
            {
