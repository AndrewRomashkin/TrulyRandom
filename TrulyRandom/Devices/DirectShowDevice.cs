...
public abstract class DirectShowDevice : IDisposable
{
    ...
    /// </summary>
    public double SamplesRecieved { get; private set; }
    /// <summary>
    /// Return actual average sample rate.
    /// </summary>
    public double ActualSampleRate { get; private set; }
    /// <summary>
    /// Return actual average bytes per sample.
    /// </summary>
    public int ActualBytesPerSample { get; private set; }
    /// <summary>
    ...
    /// </summary>
    private static readonly List<string> devicesInUse = new();
    ...
    private static bool LockDevice(string monikerString)
    {
        lock (devicesInUse)
        {
    ...
    private static void ReleaseDevice(string monikerString)
    {
        lock (devicesInUse)
        {
...
#pragma warning restore CA1031 // Do not catch general exception types
    ...
    protected DirectShowDevice(int autoSearchTimeout)
    {
        lock (GetTypeSync())
        {
    ...
    /// </summary>
    protected DirectShowDevice(DeviceDescriptor deviceDescriptor)
    {
        if (deviceDescriptor == null)
        {
            throw new ArgumentNullException(nameof(deviceDescriptor));
        }
        Name = deviceDescriptor.Name;
        monikerString = deviceDescriptor.MonikerString;
        Initialize();
    ...
    /// </summary>
    protected DirectShowDevice(string name, string monikerString)
    {
        Name = name;
    ...
    private void Initialize()
    {
        ...
        {
            throw new InvalidOperationException("This device is already in use");
        }
...
#pragma warning restore CA1031 // Do not catch general exception types
    ...
    private readonly object grabberSync = new();
    private readonly List<double> sampleIntervals = new();
    private readonly List<int> sampleSizes = new();
    private DateTime? lastDataRecieved;

    /// <summary>
    /// Handler for the data from the device.
    /// </summary>
    /// <param name="data">Sample data</param>
    private void Grabber_NewData(byte[] data)
    {
