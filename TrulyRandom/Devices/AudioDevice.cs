...
public class AudioDevice : DirectShowDevice
{
    ...
    /// </summary>
    public static IEnumerable<DeviceDescriptor> AvailableDevices => GetAvailableDevices(Clsid.AudioInputDevice);
    ...
    private static void SetCapabilities(IAMStreamConfig_Audio streamConfig, AudioCapabilities capabilities)
    {
        ...
        {
            if (capabilities == new AudioCapabilities(streamConfig, i))
            {
