...
public abstract class Extractor : Module
{
    ...
    /// </summary>
    public double ActualCompression { get; protected set; }
    /// <summary>
    /// Sources of data for this extractor.
    /// </summary>
    public IEnumerable<Module> Sources { get; set; } = Array.Empty<Module>();
    /// <summary>
    ...
    /// </summary>
    public bool NoDataToProcess { get; private set; }
    /// <summary>
    /// Total amount of bytes read by this extractor from its sources.
    /// </summary>
    public ulong TotalBytesConsumed { get; private set; }
    ...
    /// </summary>
    protected virtual bool Seedable { get; }
    ...
    /// </summary>
    private readonly List<(int Input, int Output, double Time)> history = new();
    ...
    /// </summary>
    public Module DynamicCoefficientSource { get; set; }
    ...
    private byte[] ReadDataFromSources(int count)
    {
        if (!Sources.Any())
        {
