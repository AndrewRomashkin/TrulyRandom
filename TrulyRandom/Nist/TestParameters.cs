...
#pragma warning disable CA1819 // Properties should not return arrays
    public class TestParameters
    {
        ...
        /// </summary>
        public TestType TestsToPerform { get; set; } = TestType.All;
        ...
        private double allowedFailedTestProportion;
        /// <summary>
        ...
        private double allowedFailedSubtestProportion = 0.2;
        /// <summary>
...
#pragma warning disable CA2227 // Collection properties should be read only
        public class NonOverlappingTemplateMatchingsParams
        {
            ...
            /// </summary>
            public BitArray Template { get; set; }
            /// <summary>
            ...
            /// is specified, it will be used. If none - <see cref="TemplateLength"/> will be autoselected.
            /// </summary>
            public BitArray[] Templates { get; set; }
            /// <summary>
        ...
        /// Minimum sequnce size required for the selected tests. It is still allowed to test shorter sequences, but results will be nonrepresentative.
        /// </summary>
        public static int GetMinSequenceSize(TestType tests)
        {
            IEnumerable<TestType> testFlags = tests.EnumerateFlags();
        ...
        private static int MinSequenceSizeForTest(TestType test)
        {
            return test switch
            {
                0 => 0,
                TestType.Frequency => MinSequenceSizes.Frequency,
                TestType.BlockFrequency => MinSequenceSizes.BlockFrequency,
                TestType.Runs => MinSequenceSizes.Runs,
                TestType.LongestRunOfOnes => MinSequenceSizes.LongestRunOfOnes,
                TestType.BinaryMatrixRank => MinSequenceSizes.BinaryMatrixRank,
                TestType.DiscreteFourierTransform => MinSequenceSizes.DiscreteFourierTransform,
                TestType.NonOverlappingTemplateMatchings => MinSequenceSizes.NonOverlappingTemplateMatchings,
                TestType.OverlappingTemplateMatchings => MinSequenceSizes.OverlappingTemplateMatchings,
                TestType.MaurersUniversal => MinSequenceSizes.MaurersUniversal,
                TestType.LinearComplexity => MinSequenceSizes.LinearComplexity,
                TestType.Serial => MinSequenceSizes.Serial,
                TestType.ApproximateEntropy => MinSequenceSizes.ApproximateEntropy,
                TestType.CumulativeSums => MinSequenceSizes.CumulativeSums,
                TestType.RandomExcursions => MinSequenceSizes.RandomExcursions,
                TestType.RandomExcursionsVariant => MinSequenceSizes.RandomExcursionsVariant,
                TestType.All => TestType.All.EnumerateFlags().Max(x => MinSequenceSizeForTest(x)),
        ...
        /// <param name="size">Minimum sequence size.</param>
        /// <returns></returns>
        public static TestType TestsForSize(int size)
        {
            TestType result = 0;

            foreach (TestType test in Enum.GetValues(typeof(TestType)))
            {
