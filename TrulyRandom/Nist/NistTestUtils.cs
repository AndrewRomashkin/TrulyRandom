...
/// </summary>
internal static class NistTestUtils
{
    ...
    private enum MatrixOpertion { ForwardElimination, BackwardElimination }

    private static void PerformElementaryRowOperations(MatrixOpertion flag, int i, int M, int Q, bool[,] A)
    {
        int j, k;
    ...
    private static bool FindUnitElementAndSwap(MatrixOpertion flag, int i, int M, int Q, bool[,] A)
    {
        int index;
    ...
    private static int SwapRows(int i, int index, int Q, bool[,] A)
    {
        int p;
        bool temp;
    ...
    private static int DetermineRank(int m, int M, int Q, bool[,] A)
    {
