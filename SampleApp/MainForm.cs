...
namespace SampleApp
{
    public partial class MainForm : Form
    {
        ...
        DeflateExtractor deflateExtractor1;
        DeflateExtractor deflateExtractor2;
        ShuffleExtractor shuffleExtractor;
        ...
        /// </summary>
        NistTests.TestsEnum ReadTests()
        {
            NistTests.TestsEnum result = NistTests.TestsEnum.None;

            if (checkBoxFrequency.Checked)
            {
                result |= NistTests.TestsEnum.Frequency;
            }
            if (checkBoxBlockFrequency.Checked)
            {
                result |= NistTests.TestsEnum.BlockFrequency;
            }
            if (checkBoxRuns.Checked)
            {
                result |= NistTests.TestsEnum.Runs;
            }
            if (checkBoxLongestRunOfOnes.Checked)
            {
                result |= NistTests.TestsEnum.LongestRunOfOnes;
            }
            if (checkBoxBinaryMatrixRank.Checked)
            {
                result |= NistTests.TestsEnum.BinaryMatrixRank;
            }
            if (checkBoxDft.Checked)
            {
                result |= NistTests.TestsEnum.DiscreteFourierTransform;
            }
            if (checkBoxNonOverlappingTemplateMatchings.Checked)
            {
                result |= NistTests.TestsEnum.NonOverlappingTemplateMatchings;
            }
            if (checkBoxOverlappingTemplateMatchings.Checked)
            {
                result |= NistTests.TestsEnum.OverlappingTemplateMatchings;
            }
            if (checkBoxMaurersUniversal.Checked)
            {
                result |= NistTests.TestsEnum.MaurersUniversal;
            }
            if (checkBoxLinearComplexity.Checked)
            {
                result |= NistTests.TestsEnum.LinearComplexity;
            }
            if (checkBoxSerial.Checked)
            {
                result |= NistTests.TestsEnum.Serial;
            }
            if (checkBoxApproximateEntropy.Checked)
            {
                result |= NistTests.TestsEnum.ApproximateEntropy;
            }
            if (checkBoxCumulativeSums.Checked)
            {
                result |= NistTests.TestsEnum.CumulativeSums;
            }
            if (checkBoxRandomExcursions.Checked)
            {
                result |= NistTests.TestsEnum.RandomExcursions;
            }
            if (checkBoxRandomExcursionsVariant.Checked)
            {
                result |= NistTests.TestsEnum.RandomExcursionsVariant;
            }
        ...
        private void refreshTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (tester.LastTestResult != null && lastTestReport.Text != tester.LastTestResult.Report)
            {
                ...
                lastResultFrequency.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.Frequency) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.Frequency].Success ? "Success" : "Failure");

                lastResultBlockFrequency.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.BlockFrequency) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.BlockFrequency].Success ? "Success" : "Failure");

                lastResultRuns.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.Runs) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.Runs].Success ? "Success" : "Failure");

                lastResultLongestRunOfOnes.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.LongestRunOfOnes) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.LongestRunOfOnes].Success ? "Success" : "Failure");

                lastResultBinaryMatrixRank.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.BinaryMatrixRank) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.BinaryMatrixRank].Success ? "Success" : "Failure");

                lastResultDft.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.DiscreteFourierTransform) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.DiscreteFourierTransform].Success ? "Success" : "Failure");

                lastResultNonOverlappingTemplateMatchings.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.NonOverlappingTemplateMatchings) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.NonOverlappingTemplateMatchings].Success ? "Success" : "Failure");

                lastResultOverlappingTemplateMatchings.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.OverlappingTemplateMatchings) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.OverlappingTemplateMatchings].Success ? "Success" : "Failure");

                lastResultMaurersUniversal.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.MaurersUniversal) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.MaurersUniversal].Success ? "Success" : "Failure");

                lastResultLinearComplexity.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.LinearComplexity) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.LinearComplexity].Success ? "Success" : "Failure");

                lastResultSerial.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.Serial) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.Serial].Success ? "Success" : "Failure");

                lastResultApproximateEntropy.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.ApproximateEntropy) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.ApproximateEntropy].Success ? "Success" : "Failure");

                lastResultCumulativeSums.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.CumulativeSums) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.CumulativeSums].Success ? "Success" : "Failure");

                lastResultRandomExcursions.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.RandomExcursions) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.RandomExcursions].Success ? "Success" : "Failure");

                lastResultRandomExcursionsVariant.Text = !tester.LastTestResult.TestResults.ContainsKey(NistTests.TestsEnum.RandomExcursionsVariant) ? "Not performed" :
                    (tester.LastTestResult.TestResults[NistTests.TestsEnum.RandomExcursionsVariant].Success ? "Success" : "Failure");
            }
        }
